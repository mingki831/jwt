...
//    }
    ...
    public Admin getPresentEmail(String email) {
        Optional<Admin> optionalMember = adminRepository.findByEmailId(email);
...
//    }
    ...
    public RefreshToken getDeleteToken(Admin admin) {
        Optional<RefreshToken> optionalMember = refreshTokenRepository.findByAdmin(admin);
